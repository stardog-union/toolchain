...
def _impl(ctx):
    ...
    "/Applications/Xcode9.4.1.app/Contents/Developer",
    "/Applications/Xcode10.0.app/Contents/Developer",
    "/Applications/Xcode9.2.app/Contents/Developer",
    "/Applications/Xcode9.3.1.app/Contents/Developer",
    "/Applications/Xcode9.1.app/Contents/Developer",
    "/Applications/Xcode9.3.app/Contents/Developer",
    ...
    if (ctx.attr.cpu == "armeabi-v7a"):
        ...
        or ctx.attr.cpu == "watchos_x86_64"):
        tool_paths = [
            tool_path(name = "ar", path = "osx/wrapped_ar"),
            tool_path(name = "compat-ld", path = "/usr/bin/ld"),
            tool_path(name = "cpp", path = "/usr/bin/cpp"),
            tool_path(name = "dwp", path = "/usr/bin/dwp"),
            tool_path(name = "gcc", path = "osx/cc_wrapper.sh"),

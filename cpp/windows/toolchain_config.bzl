...
def _windows_msvc_impl(ctx):
    ...
    cxx_builtin_include_directories = [
        "C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\BuildTools\\VC\\Tools\\MSVC\\14.21.27702\\include",
    ...
    cpp_link_nodeps_dynamic_library_action = action_config(
        ...
        tools = [tool(path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/link.exe")],
    )
    ...
    cpp_link_static_library_action = action_config(
        ...
        tools = [tool(path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/lib.exe")],
    )
    ...
    assemble_action = action_config(
        ...
        tools = [tool(path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/ml64.exe")],
    )
    ...
    c_compile_action = action_config(
        ...
        tools = [tool(path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/cl.exe")],
    )
    ...
    msvc_link_env_feature = feature(
        ...
        env_sets = [
            env_set(
                ...
                env_entries = [env_entry(key = "LIB", value = "C:\\Program Files (x86)\\Microsoft Visual Studio\\2019\\BuildTools\\VC\\Tools\\MSVC\\14.21.27702\\lib\\x64;C:\\Program Files (x86)\\Windows Kits\\10\\lib\\10.0.17763.0\\ucrt\\x64;C:\\Program Files (x86)\\Windows Kits\\10\\lib\\10.0.17763.0\\um\\x64;")],
            ),
        ],
    )
    ...
    tool_paths = [
        tool_path(name = "ar", path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/lib.exe"),
        tool_path(name = "ml", path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/ml64.exe"),
        tool_path(name = "cpp", path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/cl.exe"),
        tool_path(name = "gcc", path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/cl.exe"),
        tool_path(name = "gcov", path = "wrapper/bin/msvc_nop.bat"),
        tool_path(name = "ld", path = "C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.21.27702/bin/HostX64/x64/link.exe"),
...
def _windows_msys_mingw_impl(ctx):
    ...
    gcc_env_feature = feature(
        ...
        env_sets = [
            env_set (
                ...
                env_entries = [
                    env_entry(key = "PATH", value = "c:/data/msys64/mingw64/bin")
                ],
            ),
        ],
    )
 ...
 "-lstdc++"
    ...
    make_variables = []
    tool_paths = [
        tool_path (name= "ar", path= "c:/data/msys64/mingw64/bin/ar"),
        tool_path (name= "compat-ld", path= "c:/data/msys64/mingw64/bin/ld"),
        tool_path (name= "cpp", path= "c:/data/msys64/mingw64/bin/cpp"),
        tool_path (name= "dwp", path= "c:/data/msys64/mingw64/bin/dwp"),
        tool_path (name= "gcc", path= "c:/data/msys64/mingw64/bin/gcc"),
        tool_path (name= "gcov", path= "c:/data/msys64/mingw64/bin/gcov"),
        tool_path (name= "ld", path= "c:/data/msys64/mingw64/bin/ld"),
        tool_path (name= "nm", path= "c:/data/msys64/mingw64/bin/nm"),
        tool_path (name= "objcopy", path= "c:/data/msys64/mingw64/bin/objcopy"),
        tool_path (name= "objdump", path= "c:/data/msys64/mingw64/bin/objdump"),
        tool_path (name= "strip", path= "c:/data/msys64/mingw64/bin/strip"),
...
def _impl(ctx):
    ...
    tool_paths = [
        tool_path (name= "ar", path= "c:/data/msys64/usr/bin/ar"),
        tool_path (name= "compat-ld", path= "c:/data/msys64/usr/bin/ld"),
        tool_path (name= "cpp", path= "c:/data/msys64/usr/bin/cpp"),
        tool_path (name= "dwp", path= "c:/data/msys64/usr/bin/dwp"),
        tool_path (name= "gcc", path= "c:/data/msys64/usr/bin/gcc"),
        tool_path (name= "gcov", path= "c:/data/msys64/usr/bin/gcov"),
        tool_path (name= "ld", path= "c:/data/msys64/usr/bin/ld"),
        tool_path (name= "nm", path= "c:/data/msys64/usr/bin/nm"),
        tool_path (name= "objcopy", path= "c:/data/msys64/usr/bin/objcopy"),
        tool_path (name= "objdump", path= "c:/data/msys64/usr/bin/objdump"),
        tool_path (name= "strip", path= "c:/data/msys64/usr/bin/strip"),
    ...
    gcc_env_feature = feature(
        ...
        env_sets = [
            env_set (
                ...
                env_entries = [
                    env_entry(key = "PATH", value = "c:/data/msys64/usr/bin")
                ],
            ),
        ],
    )
